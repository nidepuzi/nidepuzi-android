...
public class UserInteractorImpl implements UserInteractor {
    ...
    @Override
    public void updateProfile(int id, int sex, String nick, String birthday, String province, String city, String district, ServiceResponse<ResultBean> response) {
        service.updateProfile(id, sex, nick, birthday, province, city, district)
